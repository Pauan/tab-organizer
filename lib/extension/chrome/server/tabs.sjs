...
spawn @chrome.windows.onCreated ..@each(function (window) {
  var id = @timestamp()
...
spawn @chrome.windows.onRemoved ..@each(function (id) {
...
spawn @chrome.tabs.onCreated ..@each(function (info) {
  var id = @timestamp()
...
spawn @chrome.tabs.onUpdated ..@each(function (info) {
...
spawn @chrome.tabs.onRemoved ..@each(function (info) {
...
spawn @chrome.tabs.onReplaced ..@each(function (info) {
...
spawn @chrome.tabs.onActivated ..@each(function (info) {
...
spawn @chrome.tabs.onMoved ..@each(function (info) {
...
spawn @chrome.tabs.onDetached ..@each(function (info) {
...
spawn @chrome.tabs.onAttached ..@each(function (info) {
