...
// TODO utility for this
function event(name) {
  return "__event_" + name + "__";
}


exports.popup           = {};
exports.popup.on        = {};
exports.popup.on.open   = event("popup.open");
//exports.popup.on.focus  = event("popup.focus");
exports.popup.on.close  = event("popup.close");

exports.tab             = {};
exports.tab.on          = {};
exports.tab.on.open     = event("tab.open");
exports.tab.on.update   = event("tab.update");
exports.tab.on.replace  = event("tab.replace");
exports.tab.on.focus    = event("tab.focus");
exports.tab.on.move     = event("tab.move");
exports.tab.on.close    = event("tab.close");

exports.window          = {};
exports.window.on       = {};
exports.window.on.open  = event("window.open");
//exports.window.on.focus = event("window.focus");
exports.window.on.close = event("window.close");
...
exports.popup.init = function (push) {
  popups_push.push(push);
  return popups;
};

exports.window.init = function (push) {
  windows_push.push(push);
  return windows;
};
